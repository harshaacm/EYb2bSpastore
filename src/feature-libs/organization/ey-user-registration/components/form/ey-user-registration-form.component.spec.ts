...
class MockUserRegistrationFormService
  implements Partial<EyUserRegistrationFormService>
{
...
describe('UserRegistrationFormComponent', () => {
  ...
  let userRegistrationFormService: EyUserRegistrationFormService;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        EyUserRegistrationFormComponent,
        MockUrlPipe,
        NgSelectA11yDirective,
        SpinnerComponent,
      ...
      providers: [
        {
          provide: EyUserRegistrationFormService,
    ...
    userRegistrationFormService = TestBed.inject(EyUserRegistrationFormService);
